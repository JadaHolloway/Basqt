...
/*
**********************************
MARK: Get UIImage from Binary Data
**********************************
*/
public func getUIImageFromBinaryData(binaryData: Data?, defaultFilename: String) -> UIImage {
    ...
    if let imageData = binaryData {
        ...
        if let imageObtained = uiImage {
             ...
             */
            return UIImage(named: defaultFilename)!
        }
